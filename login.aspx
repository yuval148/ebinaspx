        ...
        <div class="container">
            <form id="myform1" class="form-login" method="post" dir="rtl">
                <h2 class="form-login-heading">
                    <img src="media/LOGOr.png" style="align-content: center; width: 200px;" /></h2>
                <div class="login-wrap">
                    ...
                    <button class="btn btn-theme btn-block" id="loginbtn" type="submit" name="submit">
                    ...
                    <div class="registration">
                        ...
                        <a class="" href="signup.aspx">צור חשבון
                        </a>
                    </div>
                </div>
            </form>
