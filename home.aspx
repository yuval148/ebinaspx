...
<body style="font-family: Rubik">
    <section id="container">
      ...
      *********************************************************************************************************************************************************** -->
        ...
        <header class="header black-bg">
            ...
            <a href="home.aspx" class="logo">
                <img src="media/LOGOr.png" style="float: right; width: 170px;" /></a>
            <!--logo end-->
      ...
      *********************************************************************************************************************************************************** -->
        ...
        <section id="main-content">
            <section class="wrapper">
                <div class="row">
                    <div id="modal-battle-div"></div>
                    <div id="sub-div" class="col-lg-9 main-chart">
                        <div id="box-div" class="row mtbox">
                        </div>
                        <!-- /row mt -->
                    </div>
                    <!-- **********************************************************************************************************************************************************
      ...
      *********************************************************************************************************************************************************** -->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
	                              ...
	                              <tr>
                                      ...
                                      <td>{{level}}</td>
                                      <td>
                                          <button type="button" class="list-group-item btn-play">שחק נגד {{name}}</button></td>
                                  </tr>
                                                    {{/each}}
                                                </tbody>
                                            </table>
                ...
                <li>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 mb">
                        <div class="content-panel pn">
                            <div id="blog-bg" style="background-size: cover; background-position: center; background-image: url(../media/new/opc/{{subjectID}}.png); background-color: #{{GetMasterColor2 (GetMasterPrecent cou ctargil)}}; border-top: solid #{{GetMasterColor2 (GetMasterPrecent cou ctargil)}} 7.5px">
                    ...
                    <script id="pro-temp" type="text/x-handlebars-template">
                        {{#each sub}}
                    <p class="centered">
                        <img src="{{pic}}" class="img-circle" width="60">
                    </p>
                    ...
                    <div class="mes">
                        <div id="{{title}}" style="display: {{CheckClass kita title}}">
                            <div class="desc">
                                ...
                                <p style="font-family: Rubik; font-weight: 700; text-align: right">
                                    {{title}}<br />
                ...
                <script id="box-temp" type="text/x-handlebars-template">
            ...
            <script type="text/javascript">
                ...
                var boxInfo = document.getElementById("box-temp").innerHTML;
                var boxTemplate = Handlebars.compile(boxInfo);
                var boxData = boxTemplate(<%=this.json%>);
                document.getElementById("box-div").innerHTML += boxData;
                ...
                document.getElementById("modal-battle-div").innerHTML += modalData;
                var x;
                function isEmpty(el) {
                    return !$.trim(el.html())
                }
